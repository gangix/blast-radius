...
- `order_entry_db.analytics.order_details` feeds 3 dashboards and 12 charts downstream, but none of the tracked queries read `gift_wrap`. (BI field-level bindings aren't verified.)
